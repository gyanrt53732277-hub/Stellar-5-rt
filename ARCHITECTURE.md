...
graph TD
    ...
    subgraph SDK["Attestra SDK — TypeScript"]
        G[Signature Engine]
        H[ZK Proof Module]
        I[Module Registry]
    end
...
This diagram visualizes the interconnected nature of the Attestra ecosystem, illustrating how data and logic flow between the client, orchestration, and settlement tiers.
