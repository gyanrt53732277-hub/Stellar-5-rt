          ...
          >
            ...
            <div className="relative z-10 overflow-y-auto pr-1 scrollbar-hide">
              <div className="mb-6 text-center">
                ...
                <p className="text-slate-400 text-[11px] max-w-xs mx-auto font-medium">Choose a supported Stellar wallet to establish your secure identity on the Attestra network.</p>
              </div>
