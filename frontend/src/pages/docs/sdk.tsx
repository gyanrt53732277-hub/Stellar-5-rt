...
const SdkDocs = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-blue-500/30">
      <Head>
        <title>SDK Documentation | Attestra Protocol</title>
        <meta name="description" content="Integrate the Attestra Protocol into your dApp with our lightweight, sovereign TypeScript SDK." />
      </Head>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-white/[0.05] bg-black/20 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="font-bold tracking-tight text-xl uppercase">Attestra<span className="text-blue-500">_SDK</span></span>
          </Link>
          <div className="flex items-center gap-8 text-[10px] font-bold uppercase tracking-wider">
            <a href="https://github.com/Pritam9078/Attestra" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition-colors">GitHub</a>
        ...
        <article className="space-y-24">
          ...
          <section>
            ...
            <p className="text-xl text-slate-400 leading-relaxed max-w-2xl">
              The Attestra SDK is a lightweight, zero-dependency TypeScript library designed to embed trustless cross-chain automation directly into your application frontend or backend.
            </p>
          </section>
          ...
          <section id="install" className="scroll-mt-32">
            ...
            <div className="bg-black/40 rounded-3xl p-8 border border-white/5 relative group">
              ...
              <pre className="font-mono text-sm overflow-x-auto text-blue-300">
                <code>npm install @attestra/sdk</code>
              </pre>
          ...
          <section id="quickstart" className="scroll-mt-32">
            ...
            <div className="bg-black/40 rounded-3xl p-8 border border-white/5 relative overflow-hidden">
              ...
              <pre className="font-mono text-sm leading-relaxed overflow-x-auto">
                <code>
                  <span className="text-purple-400">import</span> {'{ AttestraSDK }'} <span className="text-purple-400">from</span> <span className="text-emerald-400">'@attestra/sdk'</span>;<br /><br />
                  <span className="text-slate-500">// 1. Initialize Client</span><br />
                  <span className="text-purple-400">const</span> sdk = <span className="text-purple-400">new</span> <span className="text-blue-400">AttestraSDK</span>({'{'}<br />
          ...
          <section id="proofs" className="scroll-mt-32">
            ...
            <p className="text-slate-400 mb-8 leading-relaxed">Attestra uses Groth16 proofs to ensure that off-chain computations are verifiably correct without revealing sensitive data.</p>
            <div className="bg-black/40 rounded-3xl p-8 border border-white/5 relative overflow-hidden">
