...
const TechnicalDocs = () => {
  ...
  const coreConcepts = [
    {
      ...
      desc: 'How Attestra verifies off-chain events and commits them to the Stellar ledger with absolute cryptographic certainty.',
      tag: 'CORE'
    },
    {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-200 selection:bg-blue-500/30 overflow-x-hidden">
      <Head>
        <title>Technical Documentation | Attestra Protocol</title>
        <meta name="description" content="Deep dive into the technical specifications, ZK architecture, and Soroban integration of the Attestra Protocol." />
      </Head>
      ...
      <main className="pt-32 pb-20 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-[280px_1fr] gap-16">
        ...
        <aside className="hidden lg:block space-y-12 sticky top-32 h-fit">
          <div className="space-y-8">
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>
                  <a href="https://github.com/Pritam9078/Attestra" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 rounded-2xl hover:bg-white/5 transition-all group">
                    <span className="text-lg">🐙</span>
          ...
          <div className="p-8 rounded-[2rem] bg-gradient-to-br from-blue-600/10 to-indigo-600/5 border border-blue-500/20 relative overflow-hidden group">
            ...
            <p className="text-[10px] text-slate-400 leading-relaxed mb-6">Explore the full mathematical foundations of Attestra's ZK-Attestation model.</p>
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <p className="text-xl text-slate-400 leading-relaxed max-w-3xl">
              Attestra is a sovereign automation protocol built on the Stellar Network, utilizing Zero-Knowledge proofs to synchronize off-chain logic with on-chain state execution.
            </p>
          </motion.div>
          ...
          <section id="architecture" className="scroll-mt-32 mb-32">
            ...
            <div className="prose prose-invert max-w-none space-y-8">
              <p className="text-lg text-slate-400 leading-relaxed">
                The protocol operates as a decentralized verification layer. When a cross-chain event occurs (e.g., a transaction on Ethereum or a price change via an oracle), Attestra verifiers capture the state and generate a cryptographic attestation.
              </p>
          ...
          <section id="zk-proofs" className="scroll-mt-32 mb-32">
            ...
            <p className="text-lg text-slate-400 leading-relaxed mb-12">
              Attestra leverages <strong>Groth16</strong> Zero-Knowledge Succinct Non-Interactive Arguments of Knowledge (zk-SNARKs) to prove that logic rules were executed correctly without exposing the underlying private data.
            </p>
               ...
               <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
                  <div>
                    ...
                    <p className="text-sm text-slate-400 leading-relaxed mb-8">
                      Attestra utilizes a globally distributed network of "Edge Verifiers" that sit closer to the data sources (Exchanges, Blockchains, IoT Gateways).
                    </p>
      ...
      <footer className="border-t border-white/[0.05] py-16 text-center text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600">
        &copy; 2026 Attestra Research_ // Distributed under the Sovereign License_
      </footer>
    </div>
  );
};
