...
const FeedbackPage = () => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-zypher-bg text-white' : 'bg-slate-50 text-slate-900'} transition-colors duration-300 relative overflow-x-hidden`}>
      <Head>
        <title>Protocol Validation | Attestra Protocol</title>
        <meta name="description" content="Share your experience with Attestra Protocol and help us shape the future of Web3 automation." />
      </Head>
                  ...
                  >
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-slate-500 dark:text-slate-400 text-lg max-w-md mx-auto">
                        Thank you for contributing to the Attestra Protocol. Your insights have been successfully recorded on the validation layer.
                      </p>
                    </div>
                    <div className="pt-8">
                      <button 
