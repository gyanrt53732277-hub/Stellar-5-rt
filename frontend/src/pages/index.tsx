    ...
    <div className="min-h-screen bg-white dark:bg-zypher-bg text-slate-900 dark:text-slate-200 selection:bg-blue-500/30 overflow-x-hidden transition-colors duration-300">
      ...
      <main className="relative z-10 container mx-auto px-6 pt-24 pb-32 flex flex-col items-center">
        ...
        >
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 mb-12 max-w-xl mx-auto leading-relaxed font-medium">
            Attestra lets you write a simple rule, prove it on-chain, and trigger actions automatically — no middlemen, no oracles, no manual steps.
          </p>
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Attestra utilizes <strong>snarkjs</strong> and <strong>circom</strong> to generate Groth16 proofs. This ensures that your off-chain logic execution is verifiably correct before it ever touches the Stellar network.</p>
                </div>
                <div>
            ...
            <div className="space-y-8 pt-20">
              <div>
                ...
                <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">Stop juggling multiple native tokens. Attestra abstracts gas costs through a unified deposit system, allowing you to pay for automation in stable credits.</p>
              </div>
              <div className="p-8 bg-gradient-to-br from-blue-600/20 to-indigo-600/10 rounded-3xl border border-blue-500/30 relative overflow-hidden group">
                ...
                <div className="bg-black/90 dark:bg-black/40 rounded-2xl p-5 mb-8 border border-white/5 font-mono text-[10px] relative">
                  ...
                  <div className="space-y-1">
                    <p className="text-blue-400"><span className="text-purple-400">import</span> {'{ Attestra }'} <span className="text-purple-400">from</span> <span className="text-emerald-400">'@attestra/sdk'</span>;</p>
                    <p className="text-slate-300"><span className="text-purple-400">const</span> client = <span className="text-purple-400">new</span> <span className="text-blue-400">Attestra</span>(<span className="text-emerald-400">'ZYPH-TEST-9F8A'</span>);</p>
      ...
      <footer className="border-t border-slate-200 dark:border-white/[0.05] p-16 text-center">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-bold uppercase tracking-[0.15em] text-slate-500">
          <p>&copy; 2026 Attestra Protocol_</p>
