...
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://attestra-peach.vercel.app/)
[![Backend API](https://img.shields.io/badge/⚡_Backend_API-Render-46E3B7?style=for-the-badge&logo=render&logoColor=white)](https://attestra.onrender.com)
[![Demo Video](https://img.shields.io/badge/🎬_Full_Walkthrough-Google_Drive-4285F4?style=for-the-badge&logo=googledrive&logoColor=white)](https://drive.google.com/file/d/1Mjnap4Wg_q3EzaHfntyq_wyE2cwGSPsv/view?usp=drive_link)
...
- **🌐 Live Demo (Frontend):** [https://attestra-peach.vercel.app/](https://attestra-peach.vercel.app/)

- **⚡ Backend API Server:** [https://attestra.onrender.com](https://attestra.onrender.com)

- **🎬 Demo Video (Full Walkthrough):** [Watch on Google Drive](https://drive.google.com/file/d/1Mjnap4Wg_q3EzaHfntyq_wyE2cwGSPsv/view?usp=drive_link)

- **📊 Pitch Deck Presentation:** [View on Google Slides](https://docs.google.com/presentation/d/1XLmArB2z2Cu40ItdaGoX4JgO0xOkrZG-/edit?usp=sharing&ouid=113915410235273315041&rtpof=true&sd=true)

- **📋 User Feedback Documentation:** [View on Google Sheets](https://docs.google.com/spreadsheets/d/1-9xB079vSkqJIRkgPVra7cMtNRsaIz1cByh-CHRgMAU/edit?usp=sharing)
...
**Attestra** is a production-grade, enterprise-ready protocol designed to **define, verify, and automate cross-chain logic with cryptographic certainty.** By eliminating centralized middlemen from state attestation, Attestra delivers a zero-trust orchestration layer secured by the Stellar network and autonomous SNARK batching.
...
> The Attestra Interface — A clean, high-fidelity command center designed for cryptographic precision.
<table>
  <tr>
...
The following Stellar Testnet wallets have verifiably interacted with the Attestra Protocol. Inspect any on [Stellar Expert](https://stellar.expert/explorer/testnet).
...
Attestra's core architecture relies on the following Soroban Smart Contracts deployed to the Stellar Testnet:

- **Execution Router Contract:** `CAARPV36FUWXN6VN6RKXLM6RP44NZQV4L5SXIATGB6PKFNBMTA5SQCSV`
- **Logic Registry Contract:** `CA2WCMQBKJYMLEQSNXZ5AEOSQPVKBBZ2ASTPBYV4TYJO5LGUPOWX46PI`
- **Proof Verifier Contract:** `CBV7B2HMH7KFXAMA6PNKT42RKEKQ37IMPA5YUDWY7TUXO2HNZJGQ5CVJ`
...
|---|---|
| **Logic Registry** | `CA2WCMQBKJYMLEQSNXZ5AEOSQPVKBBZ2ASTPBYV4TYJO5LGUPOWX46PI` |
| **Proof Verifier** | `CBV7B2HMH7KFXAMA6PNKT42RKEKQ37IMPA5YUDWY7TUXO2HNZJGQ5CVJ` |
| **Execution Router** | `CAARPV36FUWXN6VN6RKXLM6RP44NZQV4L5SXIATGB6PKFNBMTA5SQCSV` |

---

## ✦ Protocol Identity & RBAC

Attestra implements a sovereign identity model where your wallet is your passport. Access is governed by specific protocol roles with **automated profile synchronization**:
...
```bash
# 1. Clone the repo
git clone https://github.com/user/Attestra.git
cd Attestra
...
```env
PORT=5001
MONGO_URI=mongodb://localhost:27017/attestra
...
To ensure production-grade reliability, over 30 unique users were onboarded to the Attestra testnet this month. They were tasked with creating sovereign identities, deploying Logic Predicates, and interacting with the Chronos Engine.
...
Here is a look at the real-time Attestra dashboards running on the Stellar Testnet:
...
*Attestra Protocol — Where trust is a proof, not a promise.*
