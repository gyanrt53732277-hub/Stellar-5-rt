...
# Attestra Soroban Deployment Script (3-Contract Architecture)
set -e

NETWORK="testnet"
RPC_URL="https://soroban-testnet.stellar.org"

echo "🚀 Starting Attestra Triple Deployment to $NETWORK..."
...
# Paths
LOGIC_WASM="target/wasm32-unknown-unknown/release/attestra_logic_registry.wasm"
PROOF_WASM="target/wasm32-unknown-unknown/release/attestra_proof_verifier.wasm"
EXEC_WASM="target/wasm32-unknown-unknown/release/attestra_execution_router.wasm"
